              ...
              <div className="mt-10 grid max-w-xl grid-cols-1 gap-14 text-base leading-7 lg:max-w-none lg:grid-cols-2">
                <div>
                  <p className="text-justify">
                    ...
                    advancing technology and sharing knowledge. Our mission is
                    to develop tools, create self-hosted projects, and curate
                ...
                <div>
                  <p className="text-justify">
                    ...
                    processes, fostering strong and supportive relationships
                    among our members.
                  </p>
                  <p className="mt-8 text-justify">
                    Our ongoing development includes collaborative initiatives
                    such as Discord bots, wikis, and self-hosted tools, forming
                    a comprehensive educational framework enriched by our
                    collective expertise. Join us on our journey as we continue
                    to explore limitless possibilities and contribute to the
